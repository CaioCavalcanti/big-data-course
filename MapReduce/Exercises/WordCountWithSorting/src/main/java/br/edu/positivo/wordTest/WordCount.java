...
public class WordCount {
    ...
    public static class TokenizerMapper
        ...
        //
        public void map(Object key, Text value, OutputCollector<Text, IntWritable> collector, Reporter reporter)
    		throws IOException {
    ...
    public static class SortMapper
    	...
    	public void map(Object key, Text value, OutputCollector<IntWritable, Text> collector, Reporter args)
    			throws IOException {
    ...
    public static class DescendingIntWritableComparable extends IntWritable {
	    public static class DescendingKey
	    	extends Comparator {
	...
	public static void main(String[] args) throws Exception {
    	...
    	FileInputFormat.setInputPaths(sortJobConf, new Path("/tmp/temp/part-00000"));
